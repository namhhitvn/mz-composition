...
type IHttpRestRequestArguments<Params, Body, Query> = Params extends Constructor
  ? Body extends Constructor
    ? Query extends Constructor
      ? {
          0: InstanceType<Params>;
          1: InstanceType<Body>;
          2: InstanceType<Query>;
        } & [InstanceType<Params>, InstanceType<Body>, InstanceType<Query>]
    ...
    : { 0: InstanceType<Params> } & [InstanceType<Params>]
  : Body extends Constructor
  ? Query extends Constructor
...
> = [IHttpRestRequestArguments<Params, Body, Query>] extends [[]]
  ...
  : {
      new (
        ...args: IHttpRestRequestArguments<Params, Body, Query>
      ): HttpRestRequest<Response, Params, Body, Query, File>;
    };
...
> {
  ...
  public readonly params!: Params extends Constructor
    ? InstanceType<Params>
    : undefined;
  public readonly query!: Query extends Constructor
    ? InstanceType<Query>
    : undefined;
  public readonly body!: Body extends Constructor
    ? InstanceType<Body>
    : undefined;
  public readonly file!: File extends Constructor
    ? InstanceType<File>
    : undefined;

  constructor(...args: IHttpRestRequestArguments<Params, Body, Query>) {
    const self = this as any;
    const { Params, Query, Body, method, path } =
      HttpRestRequestRepository.get(self)!;
