import type { HttpRestRequestRepositoryMetadata } from '../../core/http/rest/request-repository.decorator';
import type {
  NextFunction,
  Request as ExRequest,
  Response as ExResponse,
} from 'express';
import type { ObjectLiteral } from '../../interfaces';

// eslint-disable-next-line @typescript-eslint/no-namespace
export namespace MZCore {
  ...
  export type RequestHandlerParameters<
    ...
    ReqMetadata extends RequestMetadata = RequestMetadata,
  > = Parameters<
    RequestHandler<ResBody, Params, Body, Query, Locals, ReqMetadata>
  >;
}
